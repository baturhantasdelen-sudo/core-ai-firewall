...
foreach ($name in @("DOCKER_USERNAME", "DOCKER_PASSWORD", "PROD_SERVER_IP", "PROD_SERVER_USER", "PROD_SSH_PRIVATE_KEY", "CLOUDFLARE_TUNNEL_TOKEN", "POSTHOG_API_KEY", "CLOUDFLARE_WEB_ANALYTICS_TOKEN", "PROD_PUBLIC_URL", "API_KEY_SECRET")) {
